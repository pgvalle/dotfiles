...
menubar.geometry       = { x = 5, y = 5, width = 1910, height = 30 }
-- }}}
...
awful.screen.connect_for_each_screen(function(s)
  ...
  -- Create the wibox
  local gap_size = 2 * beautiful.useless_gap
  s.mywibox = awful.wibar {
    screen       = s,
    type         = 'normal',
    width        = s.geometry.width - 2 * gap_size,
    height       = 30,
    border_color = beautiful.border_focus,
    shape        = rounded_rect
  }
  s.mywibox:geometry { x = gap_size, y = gap_size }
  s.mywibox:struts { top = s.mywibox.height + gap_size }
...
-- {{{ Key bindings
local soundcmd_prefix = 'pactl set-sink-volume $(pactl get-default-sink)'
globalkeys = gears.table.join(
    -- sound control
    awful.key({ }, "#123", function()
      awful.spawn.with_shell('pactl set-sink-volume $(pactl get-default-sink) +5%')
    end,
